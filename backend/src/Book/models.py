...
class ActionUserBaseModel(BaseModel):
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name="%(class)s_created_by")
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name="%(class)s_updated_by")
...
class Borrow(BaseModel):
    ...
    verified_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="borrow_verified_by")
    ...
    @property
    def is_overdue(self):
        if self.due_date is None or self.return_date is not None:
            return False
